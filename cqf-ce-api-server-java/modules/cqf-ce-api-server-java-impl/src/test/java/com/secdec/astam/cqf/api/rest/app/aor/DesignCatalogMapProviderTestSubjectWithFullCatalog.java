 ...
 * @author srogers
 */
public class DesignCatalogMapProviderTestSubjectWithFullCatalog extends
		DesignCatalogMapProviderTestSubject
{
	@Override
	...
	newMainDesignElementListProvider() throws IOException {
		...
		ArrayList<ExperimentDesignElementListProvider<? extends ExperimentDesignElementImpl>> result =
				super.newMainDesignElementListProvider();

        result.add(new ZipFileBackedExperimentDesignElementListProvider(
        		DesignCatalogMapProvider.mainDesignCatalog_zipFileResourceNames.get(0)
        ));
		return result;
	}
