 ...
 * @author srogers
 */
public class ExecutionPlatformToolkitTestSubject implements ExecutionPlatformToolkit
{
	@Override
	public SessionManager newSessionManager(ExecutionPlatformManager parentExecutionPlatformManager) {
		
		return new SessionManagerTestSubject(parentExecutionPlatformManager);
	}
	
	@Override
	public ExperimentManager newExperimentManager(ExecutionPlatformManager parentExecutionPlatformManager) {
		
		return new ExperimentManagerTestSubject(parentExecutionPlatformManager);
	}
