...
import static com.siegetechnologies.cqf.vsphere.api.util.mo.AUHost.underlying;
...
public class AUHostTest
{
	...
	public void testUnderlyingAndGetDelegate()
			throws Exception
	{
		assertSame(underlying(hs01), hs01.getDelegate());
	}
	...
	public void testGetName()
			throws Exception
	{
		assertEquals("hs01", hs01.getName());
	}
