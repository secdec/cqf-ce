...
/**
 * Handler for creating virtual switches.
 *
 * @param <R_main>
 ...
 * @author taylorj
 */
public class InterimVirtualSwitchExecutionHandler<R_main>
		extends BasicExecutionHandlerForTestbedVSphere<AUDistributedVirtualSwitch, R_main>
{
	...
	public AUDistributedVirtualSwitch initialize_beforeHook(ExperimentElementExecutionContext context) {
		try {
			return vSphere_toolkit_of(context).createInterimVirtualSwitchInExecutionContext(context);
		}
		finally {
	...
	public AUDistributedVirtualSwitch run_beforeHook(ExperimentElementExecutionContext context) {
		try {
			return vSphere_toolkit_of(context).getInterimVirtualSwitchInExecutionContext(context);
		}
		finally {
	...
	public Object cleanup_afterHook(ExperimentElementExecutionContext context, R_main result_main) {
		try {
			...
			vSphere_toolkit_of(context).deleteInterimVirtualSwitchInExecutionContext(context);
		}
	}
