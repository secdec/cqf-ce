 ...
 */
@FunctionalInterface
public interface ExperimentIdResolver<T extends ExperimentImpl> {
	
	/**
	 * Returns the experiment that corresponds to the specified ID (if any).
	 *
	 * @param elementId
	 * @return the corresponding experiment
	 */
	Optional<T> resolve(ExperimentId elementId);
